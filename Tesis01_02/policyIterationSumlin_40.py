...
class PolicyIterationAgent:
    ...
    def obtener_estado_rango(self):
        Y_reg_ranges = [
            ...
            (31, (1.066, 1.075)),
            (15, (0.917, 0.927)), (14, (0.908, 0.917)), (13, (0.899, 0.908)),
            (12, (0.890, 0.899)), (11, (0.880, 0.890)), (10, (0.871, 0.880)),
            (9, (0.862, 0.871)), (8, (0.852, 0.862)), (7, (0.844, 0.852)),
            (6, (0.834, 0.844)), (5, (0.825, 0.834)), (4, (0.815, 0.825)),
            (3, (0.806, 0.815)), (2, (0.797, 0.806)), (1, (0.788, 0.797)),
            (0, (0.779, 0.788))
        ]
    ...
    def policy_evaluation (self):
        ...
        # Definir los valores de Y_reg_end basados en los límites de next_state
        Y_reg_ranges = [

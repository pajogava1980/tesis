...
class PolicyIterationAgent:
    ...
    def __init__(self, nS, nA, gamma, eps, eng, prob_satis = 0.9, prob_falla = 0.7,  ip = '127.0.0.1', port = 9096):
        ...
        self.udp_socket = None  # Se inicialoza con None para la verificación en la clase marObj:
...
if __name__ == '__main__':
    ...
    agent = PolicyIterationAgent(nS = 13, nA = 4, gamma = 0.88, eps = 0.01, eng = eng, ip = '127.0.0.1', port = 9096)  # Inicializo el agent
    ...
    #ani = FuncAnimation(agent.fig, agent.update, interval=500)  # Actualiza cada 500 ms
    plt.tight_layout()
    plt.show()

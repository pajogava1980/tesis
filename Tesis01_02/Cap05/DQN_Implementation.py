...
def DQN(env_name, 
    ...
    tf.compat.v1.disable_eager_execution() #Solucionar error RuntimeError: 
    ...
    update_target_op = tf.group(*update_target) #Operación que asigna cada

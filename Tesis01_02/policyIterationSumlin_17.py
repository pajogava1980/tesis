...
class PolicyIterationAgent:
    ...
    def eval_state_action(self, Y_reg, a):
        ...
        if done:
            ...
            B = reward + self.gamma*self.V[next_state]
    ...
    def get_tap_position(self, Y_reg, a):
        ...
        """
        tap_steps = 33
        max_reg_perce = 0.10    #+-10%
        sensitivity = (max_reg_perce * 2)/(tap_steps - 1)
        num_muestras = 1
        tap_position = np.random.randint(self.pos_min_tap, self.pos_max_tap + 1, num_muestras)

...
class PolicyIterationAgent:
    ...
    def eval_state_action(self, Y_reg, a):
        ...
        #eng.set_param('AC_Feeder_Control/Clk','Value','clk')
        #Actualizo directamente en el modelo de Simulink con un valor numérico
        ...
        if Y_reg_end is None:
            ...
            return -0.5, Y_reg    #Estoy devolviendo un reward -1, pq el valor es muy bajo
    ...
    def policy_evaluation (self):
        alpha = 0.05             # Puede variar de 0.9 a 0.1 para actualizaciones mas fluidas
        max_evaluations = 25
        iteracion = 0
        delta_values = []
        while iteracion < max_evaluations:             # Formula 3.8 pag. 62, pseudocode pg. 64 miesntras PI no es estable
    ...
    def calculate_reward(self, Y_reg_end):
        ...
        reward_out_range = -0.2 #R_T penalizado para un Y_reg fuera de los rangos
...
if __name__ == '__main__':
    ...
    agent = PolicyIterationAgent(nS=5, nA=2, gamma=0.99, eps=0.01, eng=eng)  # Inicializo el agent

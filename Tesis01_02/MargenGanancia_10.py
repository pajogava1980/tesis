...
def ejecutar_calculo():
    fecha = entry_fecha.get_date().strftime("%Y-%m-%d") if entry_fecha.get_date() else ""
...
entry_fecha = DateEntry(root, date_pattern="yyyy-mm-dd", state="readonly")
...
# Obtener nombres de entidades disponibles
entidades_disponibles = obtener_entidades()

    ...
    def __init__(self, nS, nA, gamma, eps, eng):
        ...
        self.P = {
            0: {  # Estado 0: Voltaje extremadamente bajo
                ...
                # Tiene un 90% de p=0.9 de pasar al next_s=1 y tener una penalidad rew=-0.5 y 10% de quedarse en el mismo estado pnalidad = -'0
            },
...
if __name__ == '__main__':
    ...
    agent = PolicyIterationAgent(nS = 10, nA = 2, gamma = 0.99, eps = 0.0001, eng=eng)  # Inicializo el agent

...
MODEL                = AC_Feeder_Control
MODULES              = AC_Feeder_Control_acc.c AC_Feeder_Control_acc_data.c rtGetInf.c rtGetNaN.c rt_look.c rt_look1d.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/AC_Feeder_Control_acc.mexw64
MAKEFILE             = AC_Feeder_Control.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023a
START_DIR            = C:/Users/PABLO~1.GAM/ONEDRI~1/M12_TT/DRL/TESIS0~2
S_FUNCTIONS_LIB      = 
NUMST                = 2
NCSTATES             = 5
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/AC_Feeder_Control \
...
AC_Feeder_Control_acc.obj : $(START_DIR)/slprj/accel/AC_Feeder_Control/AC_Feeder_Control_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AC_Feeder_Control/AC_Feeder_Control_acc.c

AC_Feeder_Control_acc_data.obj : $(START_DIR)/slprj/accel/AC_Feeder_Control/AC_Feeder_Control_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AC_Feeder_Control/AC_Feeder_Control_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/AC_Feeder_Control/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AC_Feeder_Control/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/AC_Feeder_Control/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AC_Feeder_Control/rtGetNaN.c

rt_look.obj : $(START_DIR)/slprj/accel/AC_Feeder_Control/rt_look.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AC_Feeder_Control/rt_look.c

rt_look1d.obj : $(START_DIR)/slprj/accel/AC_Feeder_Control/rt_look1d.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AC_Feeder_Control/rt_look1d.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/AC_Feeder_Control/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/AC_Feeder_Control/rt_nonfinite.c

...
class PolicyIterationAgent:
    ...
    def eval_state_action(self, Y_reg, a):
        ...
        # Ser evisa por valores extremadamente altos
        if Y_reg_end < 0.9 or Y_reg_end > 1.1:
...
if __name__ == '__main__':
    ...
    agent = PolicyIterationAgent(nS=5, nA=2, gamma=0.85, eps=0.001, eng=eng)  # Inicializo el agent
